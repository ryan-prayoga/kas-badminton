    ...
    >
      <header className="flex items-center justify-between gap-3 rounded-xl2 border border-line bg-surface p-4 shadow-card">
        <div className="flex min-w-0 items-center gap-2.5">
          <div className="grid size-10 shrink-0 place-items-center rounded-2xl bg-court text-white shadow-court">
          ...
          <div className="min-w-0">
            ...
            {/* clamp: di layar sempit (header publik + toggle tema) judul gak kepotong */}
            <h1 className="font-display truncate text-[clamp(1rem,4.4vw,1.25rem)] font-extrabold leading-tight tracking-tight text-ink">
              Kok Badminton
            </h1>
          </div>
        </div>
        <div className="flex shrink-0 items-center gap-1.5">
          {right ?? (
            <>
              ...
              {/* Chrome publik: toggle tema di kanan tombol Admin.
                  Di chrome admin, setelan tema ada di menu Lainnya. */}
              <ThemeToggle />
            </>
          )}
        </div>
